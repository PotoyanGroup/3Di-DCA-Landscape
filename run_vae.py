...
earlystopping = keras.callbacks.EarlyStopping(monitor='loss',patience=50)
save_best_model = keras.callbacks.ModelCheckpoint(model_out,monitor='loss',mode='min',save_best_only=True)
